...
class Student:
    ...
    # This part is image labels setting start 
        ...
        dep_combo["values"]=("Select Department","Software","Electronic","Electric","Petroleum","Civil")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","BE","MS","PHD")
        cou_combo.current(0)
        ...
        #Teacher Name
        student_tutor_label = Label(class_Student_frame,text="Class Supervisor:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
